...
# header(データスキーマ)が合わない場合エラー
class UnexpextedFormat(Exception):
    def __init__(self, msg):
        self.msg = msg

# データがない場合ヘッダーのみのためエラー
class DataUnavaliable(Exception):
    def __init__(self, msg):
        self.msg = msg
...
dest_dir = '/Users/okuyamatakashi/data-science-on-gcp/02_ingest'
csvfile = os.path.join(dest_dir, '652691041_T_ONTIME.csv')
filename = '/Users/okuyamatakashi/data-science-on-gcp/02_ingest/201901.zip'
outfile = '/Users/okuyamatakashi/data-science-on-gcp/02_ingest/201901.csv'
bucket = 'pokoyakazan-test-01'
gcsloc = '/flights/raw/201501.csv'

YEAR = '2019'
MONTH = '01'
year = YEAR
month = MONTH
fileneme = download(YEAR, MONTH, dest_dir)
csvfile = zip_to_csv(filename, dest_dir)
outfile = remove_quotes_comma(csvfile, YEAR, MONTH)
verify_ingest(outfile)
