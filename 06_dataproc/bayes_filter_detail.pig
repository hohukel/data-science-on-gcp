...
alldays = 
   LOAD 'gs://pokoyakazan-test-01/flights/trainday.csv' 
...
ALLFLIGHTS = 
   LOAD 'gs://pokoyakazan-test-01/flights/tzcorr/all_flights-00000-*'
...
store result into 'gs://pokoyakazan-test-01/flights/pigoutput_detail/' using PigStorage(',','-schema');
