...
alldays = LOAD 'gs://pokoyakazan-test-01/flights/trainday.csv' 
...
ALLFLIGHTS = 
   LOAD 'gs://pokoyakazan-test-01/flights/tzcorr/all_flights-*'
...
store result into 'gs://pokoyakazan-test-01/flights/pigoutput/' using PigStorage(',','-schema');
